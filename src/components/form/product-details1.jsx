            ...
            <Row>
              ...
              <Col xs={12} md={4}>
                <div className="details_img">
                  <img
                    src="https://www.wilsondrugs.com/public/images/shatawari.jpg"
                    alt="product_img"
                  />
                </div>
              </Col>
          ...
          <div className="product-boxes">
            <div className="image-pro">
              <div
                ...
                style={{
                  backgroundImage:
                    "url(https://www.wilsondrugs.com/public/images/shatawari.jpg)",
                }}
              />
            </div>
            <h5>Ayurvedic Classical Syrup</h5>
          ...
          <div className="product-boxes">
            <div className="image-pro">
              <div
                ...
                style={{
                  backgroundImage:
                    "url(https://www.wilsondrugs.com/public/images/kanchanara.jpg)",
                }}
              />
            </div>
            <h5>Ayurvedic Classical Syrup</h5>
